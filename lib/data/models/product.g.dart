...
const ProductSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'taxRate': PropertySchema(
      ...
      name: r'taxRate',
      type: IsarType.byte,
      enumMap: _ProducttaxRateEnumValueMap,
    )
  },
...
Product _productDeserialize(
  ...
  object.taxRate =
      _ProducttaxRateValueEnumMap[reader.readByteOrNull(offsets[7])] ??
          TaxRate.exento;
  return object;
}
...
P _productDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 7:
      return (_ProducttaxRateValueEnumMap[reader.readByteOrNull(offset)] ??
          TaxRate.exento) as P;
    default:
...
const _ProducttaxRateEnumValueMap = {
  'exento': 0,
  'superReducido': 1,
  'reducido': 2,
  'general': 3,
};
const _ProducttaxRateValueEnumMap = {
  0: TaxRate.exento,
